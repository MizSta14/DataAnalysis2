...
\Listing[store=class,
         caption={Testing "$\beta_3=0$"}]{h5re12}
...
\Graphic[store=class, scale=0.45,
         caption={Plots of Prediction and Measurements}]{h5re3}
\Graphic[store=class, scale=0.45,
         caption={Plots of Prediction and Measurements}]{h5re4}
\Graphic[store=class, scale=0.45,
         caption={Plots of Prediction and Measurements}]{h5re5}
\Graphic[store=class, scale=0.45,
         caption={Plots of Prediction and Measurements}]{h5re6}
\Graphic[store=class, scale=0.45,
         caption={Plots of Prediction and Measurements}]{h5re7}
